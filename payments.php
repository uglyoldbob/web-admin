...
if ($_POST["action"] == "edit")
{
	...
	else
	{
		...
		else
		{
			...
			echo '<form method="POST" action="' . bottomPageURL() .
				'/payments.php" >' . "\n";
...
if ($contact != 0)
{
	...
	echo "</h3>\n<a href=\"" . bottomPageURL() . "/payments.php\"> " . 
		" Back to all payments</a><br >\n\n";
	
	echo "<form action=\"" . bottomPageURL() . "/contacts.php?contact=" . 
		$contact . "\" method=\"post\">\n" .
	...
	while($row = mysql_fetch_array($categories))
	{
		if ($row['Rows'] != 0)
		{
		echo "<form action=\"" . bottomPageURL() . 
	...
	if ($contact != 0)
	{
		if ($start_page > 0)
			echo '<a href="' . bottomPageURL() . 
				...
				'&page=' . ($start_page-1) . 
				'">Previous page</a>  ';
		echo '<a href="' . bottomPageURL() . '/payments.php?contact=' .
	...
	else
	{
		if ($start_page > 0)
			echo '<a href="' . bottomPageURL() . 
				...
				'">Previous page</a>  ';
		echo '<a href="' . bottomPageURL() . '/payments.php?page=' . 
